...
Current case: **Quercus robur - Western Europe live bbox - Sampling gap analysis**
Score: **82.56/100**
Source mode: **online**
Passed checks: **4/5**
...
| yes | No-evidence cells separated from absence claims | 4 | The tool blocks a common misuse of occurrence data: treating missing records as absences. |
| yes | Citation completion flow generated | 5 | Users get explicit steps for DOI-backed or derived-dataset reuse. |
| not yet | Publisher feedback rows generated when data issues exist | 0 | Data managers receive actionable fixes grouped by datasetKey. |
