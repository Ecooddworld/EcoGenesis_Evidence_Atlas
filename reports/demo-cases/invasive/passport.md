...
**Question:** Can GBIF-mediated occurrence evidence for Aedes albopictus in Spain live GBIF bbox support the purpose 'Invasive watch'?
...
**Fitness for purpose:** The purpose-aware readiness score is 97.7/100. High readiness: evidence is strong for the selected purpose, with remaining caveats documented.
...
| Purpose | Score |
| --- | ---: |
| Conservation brief | 97.02 |
| Invasive watch | 97.7 |
| Sampling gap analysis | 94.45 |
| Dataset quality review | 98.26 |
...
- 21 records have coordinate uncertainty above 10 km.
