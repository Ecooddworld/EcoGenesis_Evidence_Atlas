...
Can GBIF-mediated occurrence evidence for Aedes albopictus in Spain live GBIF bbox support the purpose 'Invasive watch'?

## 2. Evidence Basis

300 retained occurrence-style records, citation/provenance component 100.0/100, using live GBIF API records and bbox [-10.0, 35.0, 4.5, 44.5].

## 3. Fitness For Purpose

The purpose-aware readiness score is 97.7/100. High readiness: evidence is strong for the selected purpose, with remaining caveats documented.
