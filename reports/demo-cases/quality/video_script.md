...
Show the default run for Lynx pardinus in Iberian Peninsula live bbox. Point to the decision memo verdict: Usable for the selected decision with documented caveats.
...
Download the Evidence Pack. Show Submission Readiness at 8/9 checks and name the remaining DOI-backed publication case as the honest final step.
